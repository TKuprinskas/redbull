...
const fetchInventoryBalanceForTodayPrefix =
  'inventory/GET_INVENTORY_BALANCE_FOR_TODAY';

export const fetchInventory = createAsyncThunk(
  fetchInventoryPrefix,
  async (token) => {
...
export const postUserTakeInventory = createAsyncThunk(
  postUserTakeInventoryPrefix,
  async (data) => {
...
export const postUserReturnInventory = createAsyncThunk(
  postUserReturnInventoryPrefix,
  async (data) => {
    const { userId, cart, token } = data;
...
export const fetchCheckDates = createAsyncThunk(
  fetchCheckDatesPrefix,
  async (data) => {
...
export const fetchInventoryBalanceForToday = createAsyncThunk(
  fetchInventoryBalanceForTodayPrefix,
  async (token) => {
